...
export function pagesHomeDesktop(): string {
    ...
    <div class="home-content" id="top">
        ...
        <section class="home-hero">
          ...
          <video autoplay loop>
            <source src="./assets/media/6948939-uhd_3840_2160_25fps.mp4" type="video/mp4">
            <source src="./assets/media/6948939-uhd_3840_2160_25fps.webm" type="video/webm">
          </video>
          </div>
          ...
          <section>
            <div class="home-benefits">
              ...
              <div class="home-benefits-cards">
                ...
                <img src="./assets/icons/Icon__Hat.svg" alt="Hat icon">
              ...
              <div class="home-benefits__card">
                <img src="./assets/icons/Icon__Comments.svg" alt="Comments icon">
              ...
              <div class="home-benefits__card">
                <img src="./assets/icons/Icon__a-add.svg" alt="Add icon">
          ...
          <section>
            <div class="home-testimonials">
              ...
              <div class="home-testimonials-cards">
                ...
                <div class="home-testimonials__card">
                  <div class="home-testimonials__user">
                    <img class="home-testimonials__user--img1" src="./assets/img/boy01.svg" alt="photo user">
                    <div class="home-testimonials__user--name-box">
                      <h2>Mikel</h2>
                      <img src="./assets/icons/stars.svg" alt="five stars icon">
                    </div>
                  </div>                
                ...
                <div class="home-testimonials__card">
                  <div class="home-testimonials__user">
                    <img class="home-testimonials__user--img2" src="./assets/img/girl01.svg" alt="photo user">
                    <div class="home-testimonials__user--name-box">
                      <h2>Emma</h2>
                      <img src="./assets/icons/stars.svg" alt="five stars icon">
                    </div>
                ...
                <div class="home-testimonials__card">
                  <div class="home-testimonials__user">
                    <img class="home-testimonials__user--img3" src="./assets/img/boy01.svg" alt="photo user">
                    <div class="home-testimonials__user--name-box">
                      <h2>Joel</h2>
                      <img src="./assets/icons/stars.svg" alt="five stars icon">
                    </div>
              ...
              <div class="home-testimonials__buttons">
                <button class="home-testimonials__btn"><img src="./assets/icons/arrow-left.svg" alt="arrow left icon"></button>
                <button class="home-testimonials__btn"><img src="./assets/icons/arrow-right.svg" alt="arrow right icon"></button>
              </div>
    ...
    <div class="home-content-mobile">
        ...
        <section class="home-grid">
          ...
          <div class="home-grid-card">
            <img src="./assets/img/home-mobile/m-accelerator-yTsy3PYFPtc-unsplash.jpg" alt="cork with thumbtacks">
          ...
          <div class="home-grid-card">
            <img src="./assets/img/home-mobile/vitaly-gariev-2AOIg7Qvu8w-unsplash.jpg" alt="job interview">
