    ...
    <footer class="footer" id="footer">
        ...
        <form class="footer__form">
          <div class="footer__input-box">
            <img src="./assets/icons/Mail.svg" alt="postal card icon" class="footer__input-icon">
      ...
      <div class="footer__nav-box">
        <img class="footer__logo" src="./assets/img/Logo_invert.svg" alt="Logo Alumni negative">
      ...
      <div class="footer__bottom">
        ...
        <div class="footer__social-icons">
          <img src="./assets/icons/LogoFacebook.svg" alt="Facebook icon">
          <img src="./assets/icons/LogoLinkedin.svg" alt="Linkedin icon">
          <img src="./assets/icons/LogoYoutube.svg" alt="Youtube icon">
        </div>
      </div>
